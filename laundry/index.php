...
<div class="container">
	...
	<i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:Thelaundry@Gmail.com">cleanxpress@gmail.com</a>
	</div>
	<div class="col-md-6 w3_c">
	<i class="fa fa-phone" aria-hidden="true"></i> 081231231231
	</div>
...
<nav class="navbar navbar-default ">
  <div class="container">
    <div class="navbar-header">
     ...
     <h1><a class="navbar-brand" href="#">CleanXpress</a></h1>
    </div>
...
<a href="#" data-toggle="modal" data-target="#myModal">Read More </a>
  <div class="modal video-modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModal">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">CleanXpress</h4>
        </div>
		...
		<div class="container">
			<div class="list">
				...
				<div class="col-md-6 wthree_fc">
					...
					<h6>081231231231</h6>
					<h6><a href="mailto:service@decorate.com">cleanxpress@gmail.com</a></h6>
					</div>
			</div>
		</div>
	</div>
<div class="copyright">
		<div class="container">
			<p>© <?php echo date('Y');?> CleanXpress.</p>
		</div>
</div>
