  ...
  <div class="col-md-9 register-right">
    ...
    <div class="row register-form">
      <div class="col-md-12">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>Pick Up date</label><span id="P_date1"></span>
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>Delivery Date</label><span id="D_date1"></span>
            <input type="date" class="form-control" required="" id="D_date" placeholder="Last Name *" value="" />
          </div>
        </div>
        <div class="col-md-12">  
          <div class="form-group">
            <label>Address</label><span id="Address1"></span>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <option class="hidden"  selected >Service Type</option>
            <?php $Show1=Serv_Type();
						$count='0';
...
function submit(){
  ...
  if(P_date==''){
    document.getElementById("P_date1").innerHTML = " (Please enter Pick Up Date)";
     exit();
  }
  if(D_date==''){
